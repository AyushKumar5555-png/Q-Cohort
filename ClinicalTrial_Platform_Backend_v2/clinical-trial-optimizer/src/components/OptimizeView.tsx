...
export default function OptimizeView({
  ...
  const optimizedSites = [
    {
      id: 0,
      name: "AIIMS Delhi Clinical Oncology",
    ...
    {
      id: 1,
      name: "JIPMER Regional Cancer Centre",
      location: "Puducherry, IND",
      geneticMatch: 98.1,
      cap: 320,
      efficiency: "Optimal",
      chief: "Dr. Rakesh Aggarwal",
      queueCapacity: "28% Load",
      equipmentStatus: "Active Calibration Checked",
    },
    {
      id: 2,
      name: "MedGenome Genomic Labs",
      location: "Bangalore, IND",
      geneticMatch: 97.5,
      cap: 290,
      efficiency: "Optimal",
      chief: "Dr. Vedam Ramprasad",
      queueCapacity: "41% Load",
      equipmentStatus: "Active Calibration Checked",
    },
    {
      id: 3,
      name: "Eurofins Genomics India",
      location: "Bangalore, IND",
      geneticMatch: 95.8,
      cap: 310,
      efficiency: "Stable",
      chief: "Dr. B. K. Sathyanarayana",
