      ...
      >
        ...
        <div>
          <h1 className="text-lg font-serif font-bold tracking-tight text-slate-900 flex items-center gap-1.5 group-hover:text-[#2563EB] transition-colors">
            QC <span className="text-blue-700 text-xs font-mono px-1.5 py-0.5 rounded bg-blue-50 text-[10px] border border-blue-100">Enterprise</span>
          </h1>
          <p className="text-[10px] text-slate-500 tracking-wider uppercase font-mono mt-0.5">Q-Cohort</p>
        </div>
      </div>
